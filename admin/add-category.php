    ...
    <div class="wrapper">
        ...
        if (isset($_POST['submit'])) {
            ...
            if (isset($_FILES['image']['name'])) {
                ...
                // Uplaod Image only if image is selected
                if ($image_name != "") {

                    // Auto Rename our Image
                    // Get the extention of our image (jpg, png, gif, etc) eg. "specialfood1.jpg";
                    $ext = end(explode('.', $image_name));

                    // Rename the image
                    $image_name = "Food_Category_" . rand(000, 999) . '.' . $ext; //e.g. Food_Category_456
            ...
            // 4.Check whether the query is wexecuted or not and data added or not
            if ($res == true) {
